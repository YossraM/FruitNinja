...
public class Banana implements Fruit {
 ...
 private final Image img1 = new Image(getClass().getResourceAsStream("banana.png"));
  private final Image img2 = new Image(getClass().getResourceAsStream("banana-1.png"));
