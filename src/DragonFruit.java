...
public class DragonFruit extends SpecialFruit {
    ...
    ImageView image;
    private final Image img = new Image(getClass().getResourceAsStream("Dragonfruit.png"));
    int posX;
    int posY;

    DragonFruit() {
        image = new ImageView(new Image(getClass().getResourceAsStream("Dragonfruit.png")));
